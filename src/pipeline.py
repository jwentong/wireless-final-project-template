...
def run_system(input_path, output_path, snr_db=12, seed=2026, modulation="qpsk", channel="awgn"):
    ...
    through_channel = awgn(np.concatenate([prefix, tx_symbols]), snr_db=snr_db, seed=seed)
    ...
    recovered_frame_bits = qpsk_demodulate(aligned)
    ...
    _write_plots(results_dir, aligned, sync_result["correlation"], bit_error_rate)
    return metrics
